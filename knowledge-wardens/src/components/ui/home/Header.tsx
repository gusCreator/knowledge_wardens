  ...
  return (
    ...
    >
      ...
      <div className='hidden md:block'>
        <Image src="/images/characters/prince.png" alt="Queen" width={350} height={500}
          className='absolute top-[40%] left-[4%] z-10'
        />
        <Image src="/images/characters/witch2.png" alt="Witch" width={400} height={200}
          className='absolute 
        top-[34%] right-[2%] z-10'
        />
      </div>
