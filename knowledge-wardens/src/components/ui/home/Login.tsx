...
export function Login() {
  return (
    <div className="flex flex-col items-center justify-center w-full gap-4 min-w-80">
      <h3 className="text-center text-3xl lg:text-4xl xl-text-4xl text-orange-600 font-extrabold">Start adventure</h3>  
